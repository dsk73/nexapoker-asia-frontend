  ...
  return (
    <section className="px-6 pb-20 sm:pb-24 lg:pb-28">
      <div className="container-nexa">
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#0a0d14]">
          {/* =================================================
              BACKGROUND GLOW
          ================================================= */}

          <div className="pointer-events-none absolute -right-32 -top-32 h-72 w-72 rounded-full bg-[#1877ff]/10 blur-3xl" />

          <div className="pointer-events-none absolute -bottom-32 -left-32 h-72 w-72 rounded-full bg-[#ff1764]/5 blur-3xl" />
          ...
          <div className="relative flex flex-col gap-8 p-6 sm:p-8 lg:flex-row lg:items-center lg:gap-10 lg:p-10">
            ...
            <div className="min-w-0 flex-1">
              ...
              {page.BottomDescription && (
                <p className="mt-3 max-w-4xl text-sm leading-6 text-white/55 sm:text-base sm:leading-7">
                  {page.BottomDescription}
                </p>
              )}
            </div>
            ...
            <div className="flex w-full shrink-0 flex-col gap-3 sm:w-auto sm:min-w-55">
              {page.LINEID && (
                <div className="rounded-xl border border-[#1877ff]/30 bg-[#1877ff]/5 px-4 py-3">
                  <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[#46b9ff]">
                    Telegram ID
                  </p>
              ...
              {page.LINEButtonText && page.LINEButtonURL && (
                <a
                  ...
                  className="inline-flex w-full items-center justify-center rounded-xl bg-[#1877ff] px-6 py-3 text-sm font-semibold text-white transition-all duration-200 hover:bg-[#46b9ff] hover:shadow-[0_10px_35px_rgba(24,119,255,0.25)]"
                >
                  {page.LINEButtonText}
                </a>
              )}
